...
- This course covers the basic manipulator operation and programming of EPSON and ABB robotic arms, as well as machine vision, human-machine interface, and peripheral I/O integration. Students should work in a team to have a better comprehension of the robot system.  This course is intensive and may be shortened or reduced based on course requirements. (Course hour arrangement suggestion: Intensive course 32 hours, standard course time 64 hours.)
